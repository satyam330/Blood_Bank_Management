...
def update_approve_status(request, id):
    # Your logic for approving blood request
    messages.success(request, "Blood request approved successfully!")
    return redirect('your-view-name')  # Replace 'your-view-name' with the actual name of the view

def update_reject_status(request, id):
    # Your logic for rejecting blood request
    messages.error(request, "Blood request rejected.")
    return redirect('your-view-name')  # Replace 'your-view-name' with the actual name of the view
